...
EMG_CONFIG.webin.token_endpoint = "http://fake-auth.example.com/token"
EMG_CONFIG.webin.account_details_endpoint = "http://fake-auth.example.com/account"
EMG_CONFIG.rt.url = "http://fake-rt.example.com/REST/2.0"
