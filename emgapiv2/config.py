...
class RawReadsPipelineConfig(BaseModel):
    ...
    rawreads_pipeline_config_file: str = (
        "/hps/software/users/rdf/metagenomics/service-team/configs/pipelines-nextflow-configs/pipelines/raw-reads-analysis-pipeline/codon.conf"
    )
