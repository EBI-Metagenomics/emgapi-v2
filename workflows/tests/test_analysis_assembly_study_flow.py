...
def setup_study_summary_fixtures(study: Study):
    ...
    merge_assembly_study_summaries flow, in the pipeline-versioned subdirectory
    (e.g. ``results_dir/asa_v6/``) where add_assembly_study_summaries_to_downloads
    ...
    for summary_type in summary_types:
        summary_file = (
            summary_dir / f"{study.first_accession}_{summary_type}_study_summary.tsv"
        )
