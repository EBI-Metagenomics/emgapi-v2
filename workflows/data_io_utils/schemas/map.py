"""
MAP (Mobilome Annotation Pipeline) result schema using the unified base classes.

This module provides the schema definition for MAP pipeline results,
creating validation and download generation for mobilome annotation outputs.
"""
